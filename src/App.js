...
class App extends Component {
  ...
  render() {
    const arrOfCharacters = this.state.input
      .split("")
      .map((char, index) => (
        <CharComponent
          key={index}
          char={char}
          onDelete={() => this.handleDeleteChar(index)}
        />
      ));
    ...
    return (
      <div className="App">
        ...
        <input value={this.state.input} onChange={this.handleOutputLength} />
